...
Public Class frmComplaintType_Entry
    ...
    Private Sub btnEntry_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEntry.Click
        ...
        Else
            If Me.btnEntry.Text = "Save" Then
                ...
                Dim sqlString As String = "INSERT INTO tblComplaintType (Title,Description) VALUES ('" & Me.txtTitle.Text & "','" & Me.txtDescription.Text & "')"
                Dim cmd As New MySqlCommand(sqlString, cn)

                cmd.ExecuteNonQuery()

                MessageBox.Show("The type of complaint has been successfully saved.", "Saved", MessageBoxButtons.OK, MessageBoxIcon.Information)
                frmComplaintType_View.LoadData()
                Me.btnCancel_Click(sender, e)
            End If
        End If
    End Sub

    Private Sub frmComplaintType_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call GetGlobalBG(Me)
    End Sub
