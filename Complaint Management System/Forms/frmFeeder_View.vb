...
#Region "Load List"
    ...
    Public Sub LoadData()
        FillListview("SELECT * FROM tblFeederName")
    End Sub
...
#End Region
    ...
    Private Sub frmFeeder_View_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call GetGlobalBG(Me)
        LoadData()
    End Sub
    ...
    Private Sub AddToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddToolStripMenuItem.Click
        With frmFeeder_Entry
            .Text = "Add New Feeder name"
            .btnEntry.Text = "Save"
            .ShowDialog()
            .txtTitle.Focus()
        End With
    ...
    Private Sub DeleteToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteToolStripMenuItem.Click
        ...
        If MessageBox.Show("Are you sure you want to delete feeder name " & Me.lstvw.SelectedItems(0).SubItems(1).Text & "?", "confirm delete?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            StrSelect = "DELETE FROM tblFeederName WHERE ID= '" & Me.lstvw.SelectedItems(0).SubItems(0).Text & "'"
