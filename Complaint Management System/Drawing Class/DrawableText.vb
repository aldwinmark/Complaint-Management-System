...
Public Class DrawableText
    ...
    Public Sub New()
    End Sub
    Public Sub New(ByVal strFontSize As String, ByVal str As String, ByVal fore_color As Color, ByVal fill_color As Color, Optional ByVal line_width As Integer = 0, Optional ByVal new_x1 As Integer = 0, Optional ByVal new_y1 As Integer = 0, Optional ByVal new_x2 As Integer = 1, Optional ByVal new_y2 As Integer = 1)
    ...
    Public Overrides Sub Draw(ByVal gr As System.Drawing.Graphics)
        ...
        'gr.FillRectangle(DBNull, rect)
        'fill_brush.Dispose()

        ' See if we're selected.
        If IsSelected Then
            ' Draw the rectangle highlighted.
            Dim highlight_pen As New Pen(HLineColor, LineWidth)
        ...
        Else
            Dim tmpFont As New Font("Arial", FontSize, FontStyle.Bold)

            ' Just draw the rectangle.
            Dim fg_pen As New Pen(ForeColor, LineWidth)
            gr.DrawRectangle(fg_pen, rect)
            gr.DrawString(InputString, tmpFont, brush, rect)
            fg_pen.Dispose()
        End If
    End Sub
