...
Public Class crptWeeklyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Complaint_Management_System.crptWeeklyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptWeeklyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptWeeklyReport = New crptWeeklyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
