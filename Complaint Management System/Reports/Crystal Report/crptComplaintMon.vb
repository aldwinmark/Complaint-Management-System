...
Public Class crptComplaintMon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Complaint_Management_System.crptComplaintMon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptComplaintMon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptComplaintMon = New crptComplaintMon()
        rpt.Site = Me.Site
        Return rpt
    End Function
