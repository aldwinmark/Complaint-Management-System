...
Public Class crptERCReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Complaint_Management_System.crptERCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptERCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptERCReport = New crptERCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
