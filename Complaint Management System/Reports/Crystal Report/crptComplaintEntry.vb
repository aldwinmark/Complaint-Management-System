...
Public Class crptComplaintEntry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Complaint_Management_System.crptComplaintEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptComplaintEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptComplaintEntry = New crptComplaintEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
