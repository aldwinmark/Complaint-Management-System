...
Public Class crptRouteSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Complaint_Management_System.crptRouteSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptRouteSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptRouteSlip = New crptRouteSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
